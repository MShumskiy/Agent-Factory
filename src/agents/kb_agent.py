...
class KBAgent:
    ...
    def kb_agent_response(self, user_prompt, temperature=0):
        ...
        prompt = f"{user_prompt}\nwhich of the following knowledge bases would you use?\n {tools_description}. Provide only the name of the selected knowledge base and nothing else. Respond in less than 10 words."
    ...
    def kb_agent_chat(self, user_prompt,override_config=None,standalone=None):
            """
